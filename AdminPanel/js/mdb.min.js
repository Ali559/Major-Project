...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (e, t, i, n, o) {
      ...
      return (
        s * Math.pow(2, -10 * t) * Math.sin(((t * o - a) * (2 * Math.PI)) / r) +
        n +
        i
      );
    },
    ...
    easeInBack: function (e, t, i, n, o, a) {
      return (
        null == a && (a = 1.70158), n * (t /= o) * t * ((a + 1) * t - a) + i
      );
    },
        ...
        return (function (e, t, i, n) {
                  ...
                  for (
                    ...
                    if (a(S)) {
                      ...
                      for (var T in (d.visibility !== n &&
                        "hidden" !== d.visibility &&
                        b.setPropertyValue(S, "visibility", d.visibility),
                      k))
                        if ("element" !== T) {
                          var $,
                            O = k[T],
                            I = h.isString(O.easing)
                              ? g.Easings[O.easing]
                              : O.easing;
                          if (1 === v) $ = O.endValue;
                          else {
                          ...
                          if (((O.currentValue = $), "tween" === T)) m = $;
                            ...
                            if (b.Hooks.registered[T]) {
                              var E = b.Hooks.getRoot(T),
                                P = a(S).rootPropertyValueCache[E];
                              P && (O.rootPropertyValue = P);
                            }
                            var M = b.setPropertyValue(
                              S,
                              T,
                              O.currentValue +
                                (0 === parseFloat($) ? "" : O.unitType),
                              O.rootPropertyValue,
                              O.scrollData
                            );
                            b.Hooks.registered[T] &&
                              (a(S).rootPropertyValueCache[E] = b.Normalizations
                                .registered[E]
                                ? b.Normalizations.registered[E](
                                    "extract",
                                    null,
                                    M[1]
                                  )
                      ...
                      d.mobileHA &&
                        a(S).transformCache.translate3d === n &&
                        ((a(S).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (C = !0)),
            ...
            for (
              ...
              if (
                (t ||
                  ...
                  "hidden" === r.visibility &&
                    b.setPropertyValue(p, "visibility", r.visibility)),
                !0 !== r.loop &&
                  (u.queue(p)[1] === n ||
                    !/\.velocityQueueEntryFlag/i.test(u.queue(p)[1])) &&
                  a(p))
              ) {
                ...
                u.each(b.Lists.transforms3D, function (e, t) {
                  ...
                  r.mobileHA &&
                    ((h = !0), delete a(p).transformCache.translate3d),
          ...
          if (!(7 >= d)) {
              ...
              getPropertyValue: function (e, i, o, r) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var h =
                          ...
                          (parseFloat(b.getPropertyValue(e, "paddingTop")) ||
                            0) -
                          (parseFloat(b.getPropertyValue(e, "paddingBottom")) ||
                            0);
                        return o(), h;
                      }
                      if (
                        ...
                        var f =
                          ...
                          (parseFloat(b.getPropertyValue(e, "paddingLeft")) ||
                            0) -
                          (parseFloat(b.getPropertyValue(e, "paddingRight")) ||
                            0);
                        return o(), f;
                      }
                    }
                ...
                if (b.Hooks.registered[i]) {
                  var c = i,
                    p = b.Hooks.getRoot(c);
                  o === n &&
                    (o = b.getPropertyValue(e, b.Names.prefixCheck(p)[0])),
            ...
            var w = function () {
                ...
                function e(e) {
                  function p(e, t) {
                    ...
                    return (
                      h.isArray(e)
                        ...
                        : (i = e),
                      t || (o = o || c.easing),
                      h.isFunction(i) && (i = i.call(r, C, S)),
                      h.isFunction(a) && (a = a.call(r, C, S)),
                      [i || 0, o, a]
                    );
                  }
                  function f(e, t) {
                  ...
                  function m() {
                    var e = {
                      ...
                      n =
                        e.position === _.lastPosition &&
                        e.myParent === _.lastParent,
                      o = e.fontSize === _.lastFontSize;
                    (_.lastParent = e.myParent),
                      (_.lastPosition = e.position),
                      (_.lastFontSize = e.fontSize);
                    var s = 100,
                      l = {};
                    if (o && n)
                      (l.emToPx = _.lastEmToPx),
                        (l.percentToPxWidth = _.lastPercentToPxWidth),
                        (l.percentToPxHeight = _.lastPercentToPxHeight);
                    else {
                      var c = a(r).isSVG
                        ? i.createElementNS(
                    ...
                    return (
                      null === _.remToPx &&
                        (_.remToPx =
                          ...
                          16),
                      null === _.vwToPx &&
                        ((_.vwToPx = parseFloat(t.innerWidth) / 100),
                        (_.vhToPx = parseFloat(t.innerHeight) / 100)),
                      (l.remToPx = _.remToPx),
                      (l.vwToPx = _.vwToPx),
                      (l.vhToPx = _.vhToPx),
                      g.debug >= 1 &&
                  ...
                  if ("scroll" === $) {
                    ...
                    c.container
                      ? h.isWrapped(c.container) || h.isNode(c.container)
                        ? ((c.container = c.container[0] || c.container),
                          (T =
                            (w = c.container["scroll" + I]) +
                            u(r).position()[I.toLowerCase()] +
                            A))
                        : (c.container = null)
                      : ((w =
                          g.State.scrollAnchor[g.State["scrollProperty" + I]]),
                        (k =
                          g.State.scrollAnchor[
                            g.State[
                    ...
                    "none" === a(r).opts.display &&
                      ...
                      x.easing || delete c.easing,
                      x.duration || delete c.duration,
                      (c = u.extend({}, a(r).opts, c));
                    var E = u.extend(!0, {}, a(r).tweensContainer);
                    for (var P in E)
                      if ("element" !== P) {
                        var M = E[P].startValue;
                        (E[P].startValue = E[P].currentValue = E[P].endValue),
                          (E[P].endValue = M),
                          h.isEmptyObject(x) || (E[P].easing = c.easing),
                          g.debug &&
                            console.log(
                    ...
                    for (var L in (a(r).tweensContainer &&
                      !0 === a(r).isAnimating &&
                      (E = a(r).tweensContainer),
                    u.each(y, function (e, t) {
                      if (
                        RegExp("^" + b.Lists.colors.join("$|^") + "$").test(e)
                      ) {
                        var i = p(t, !0),
                          o = i[0],
                          a = i[1],
                    ...
                    y)) {
                      ...
                      if (
                        a(r).isSVG ||
                        "tween" === H ||
                        !1 !== b.Names.prefixCheck(H)[1] ||
                        b.Normalizations.registered[H] !== n
                      ) {
                        ((c.display !== n &&
                          null !== c.display &&
                          "none" !== c.display) ||
                          ...
                          0 !== R &&
                          (F = 0),
                          c._cacheValues && E && E[L]
                            ? (F === n && (F = E[L].endValue + E[L].unitType),
                              (W = a(r).rootPropertyValueCache[H]))
                            : b.Hooks.registered[L]
                            ? F === n
                              ? ((W = b.getPropertyValue(r, H)),
                                (F = b.getPropertyValue(r, L, W)))
                              : (W = b.Hooks.templates[H][1])
                            : F === n && (F = b.getPropertyValue(r, L));
                        var Y,
                          N,
                          z,
                          B = !1;
                  ...
                  d.element &&
                    ...
                    (a(r).isAnimating = !0),
                    C === S - 1
                      ? (g.State.calls.push([D, v, c, null, O.resolver]),
                        !1 === g.State.isTicking &&
              ...
              if (
                  ...
                  for (var T = f + 1; T < arguments.length; T++)
                    ...
                    (!/^(fast|normal|slow)$/i.test(arguments[T]) &&
                      ...
                      ? h.isString(arguments[T]) || h.isArray(arguments[T])
                        ? (x.easing = arguments[T])
                        : h.isFunction(arguments[T]) &&
                          (x.complete = arguments[T])
                      : (x.duration = arguments[T]);
                }
                var $,
                ...
                switch (
                  ...
                  default:
                    if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
                        ...
                        return (
                          ...
                          u.each(v, function (e, t) {
                            parseFloat(L.stagger)
                              ? (L.delay = E + parseFloat(L.stagger) * e)
                              : h.isFunction(L.stagger) &&
                                (L.delay = E + L.stagger.call(t, e, S)),
                              L.drag &&
                                ((L.duration =
                                  parseFloat(A) ||
                      ...
                      return (
                        O.promise ? O.rejecter(new Error(P)) : console.log(P),
                        e()
                      );
                    }
                    $ = "start";
                ...
                if (
                  ...
                  ((L = u.extend({}, g.defaults, x)).loop = parseInt(L.loop)),
                  (M = 2 * L.loop - 1),
                  L.loop)
                )
                  for (var V = 0; M > V; V++) {
            ...
            return (
              ...
              (e.Velocity = g),
              e !== t &&
                ((e.fn.velocity = w), (e.fn.velocity.defaults = g.defaults)),
                ...
                ? ((t = window.innerHeight),
                  ...
                  e(".wow.animated").each(function () {
                    if (
                      ...
                      var i =
                        1e3 * e(this).css("animation-duration").slice(0, -1);
                      e(this).attr("data-wow-delay") &&
                        (i +=
                          1e3 * e(this).attr("data-wow-delay").slice(0, -1));
                      var n = this;
                      setTimeout(function () {
  ...
  (function (e, t) {
    ...
    return (
      ...
      (e.calm = function (e) {
        for (
          var t = { type: "mouseup", button: 1 }, i = 0, n = (e = a(e)).length;
          i < n;
          i++
        )
          l.hide(t, e[i]);
...
dropdownSelectors.on({
  ...
  $(".multi-level-dropdown .dropdown-submenu > a").on("mouseenter", function (
    e
  ) {
    var t = $(this);
...
jQuery(function (e) {
  ...
  (function (e) {
      ...
      var p = !1,
        ...
        b = (y.prototype = {
              ...
              : ((h.methods = {}),
                ...
                (function () {
                  v
                    ...
                    f.editable || v.on("keydown." + h.id, S);
                  var i, o, a, r;
                  l(t, {
                    haspopup: !0,
                    expanded: !1,
          ...
          render: function (t) {
            return (
              t
                ? ((b.$holder = e(w())), x(), b.$root.html(b.$holder))
              ...
              for (o in (r || (s[t] = i), s))
                (a = s[o]),
                  o in b.component.item &&
                    (void 0 === a && (a = null), b.component.set(o, a, n)),
                  ("select" != o && "clear" != o) ||
                    !f.updateInput ||
                    v
          ...
          get: function (e, i) {
            ...
            if (e in b.component.item) {
              if ("string" == typeof i) {
                ...
                return n
                  ? a._.trigger(b.component.formats.toString, b.component, [
                      i,
                      n,
                    ])
                  : "";
    ...
    function r() {
      ...
      var i = e('<div style="visibility:hidden;width:100px" />').appendTo(
          "body"
        ),
        o = i[0].offsetWidth;
  ...
  (function (e) {
    ...
    (o.prototype.set = function (e, t, i) {
      ...
      return null === t
        ...
        : ((o["enable" == e ? "disable" : "flip" == e ? "enable" : e] = n.queue[
            e
          ]
            .split(" ")
            .map(function (o) {
      ...
      (o.prototype.disabled = function (e) {
        ...
        return (
          ...
          -1 === i.item.enable
            ? !o
            : o || e.pick < i.item.min.pick || e.pick > i.item.max.pick
        );
      }),
        ...
        return {
          ...
          toString: function (e, t) {
            ...
            return i.formats
              ...
              .map(function (e) {
                return (
                  n.trigger(i.formats[e], i, [0, t]) || e.replace(/^!/, "")
                );
              })
              .join("");
          },
      ...
      (o.prototype.nodes = function (e) {
        var t,
          ...
          h = r.max,
          f =
            ((t = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(
              0
            )),
  ...
  (function () {
    ...
    function T(e, t) {
      var i,
        ...
        A = I ? e : e.find("input"),
        E = (A.prop("type"), n("label[for=" + A.attr("id") + "]")),
        P = this;
      if (
      ...
      t.darktheme && r.addClass("darktheme"),
        ...
        A.on("click.clockpicker", m(n.proxy(this.show, this), 100));
      var L,
        _,
        D,
        V,
      ...
      if (
        ...
        var W = r.find(".clockpicker-canvas"),
          Y = f("svg");
        Y.setAttribute("class", "clockpicker-svg"),
          Y.setAttribute("width", k),
  ...
  (function (e, t) {
    ...
    return function (e, t, i, n) {
      ...
      var s,
        ...
        Ye = function (e) {
          e && (q || X || te || Y) && (e.preventDefault(), e.stopPropagation());
        },
        Ne = function () {
        ...
        Be = 0,
        Xe = function (e) {
          ze[e] && (ze[e].raf && M(ze[e].raf), Be--, delete ze[e]);
        },
        qe = function (e) {
          ze[e] && Xe(e), ze[e] || (Be++, (ze[e] = {}));
        },
        Ue = function () {
        ...
        Ke = function (e, t, i, n, o, a, r) {
          ...
          var c = function () {
            if (ze[e]) {
              if ((s = Te() - l) >= n) return Xe(e), a(i), void (r && r());
          ...
          init: function () {
            if (!s && !l) {
              ...
              t && (a.ui = new t(a, o)).init(),
                ...
                void 0 === V && (Ce("initialLayout"), (V = _ = o.getScrollY()));
              var c = "pswp--open ";
              for (
                ...
                Ee((i + p) * fe.x, k[i].el.style);
              D || o.bind(a.scrollWrap, f, a),
              ...
              if (!(e && 2 > i)) {
                ...
                for (var n = 0; i > n; n++)
                  me > 0
                    ? ((t = k.shift()),
                      (k[2] = t),
                      Ee((++p + 2) * fe.x, t.el.style),
                      a.setContent(t, u - i + n + 1 + 1))
                    : ((t = k.pop()),
                      k.unshift(t),
                      Ee(--p * fe.x, t.el.style),
                      a.setContent(t, u + i - n - 1 - 1));
                if (ee && 1 === Math.abs(me)) {
                  var o = Ft(S);
                  o.initialZoomLevel !== v && (Bt(o, de), Kt(o), Ae(o));
                }
          ...
          updateSize: function (t) {
            ...
            if (
              ...
              for (var n, s, l, c = 0; 3 > c; c++)
                (n = k[c]),
                  Ee((c + p) * fe.x, n.el.style),
                  (l = u + c - 1),
                  r.loop && Ht() > 2 && (l = xe(l)),
                  (s = Ft(l)) && (x || s.needsUpdate || !s.bounds)
                    ? (a.cleanSlide(s),
                      a.setContent(n, l),
                      1 === c && ((a.currItem = s), a.updateCurrZoomItem(!0)),
                      (s.needsUpdate = !1))
                    : -1 === n.index && l >= 0 && a.setContent(n, l),
                  s && s.container && (Bt(s, de), Kt(s), Ae(s));
              x = !1;
            }
            (g = v = a.currItem.initialZoomLevel),
              (J = a.currItem.bounds) &&
                ((ue.x = J.center.x), (ue.y = J.center.y), Ie(!0)),
              Ce("resize");
          },
        ...
        Ct = function (e) {
          ...
          return (
            A
              ...
              ? e.touches &&
                e.touches.length > 0 &&
                ((St[0] = yt(e.touches[0], xt)),
                e.touches.length > 1 && (St[1] = yt(e.touches[1], kt)))
              : ((xt.x = e.pageX),
                (xt.y = e.pageY),
                (xt.id = ""),
                (St[0] = xt)),
        ...
        $t = function (e) {
          if (!("mousedown" === e.type && e.button > 0)) {
            ...
            if (!N || "mousedown" !== e.type) {
              if ((gt(e, !0) && e.preventDefault(), Ce("pointerDown"), A)) {
            ...
            if (0 !== e)
              if (
                ...
                if (
                  ...
                  return;
                Le(Ge, Z[1]), X || ((X = !0), Ce("zoomGestureStarted"));
                var t = pt(Qe, Ge),
                  i = Lt(t);
                i >
                ...
                if (
                  ...
                  (le.y += Je.y), (ue.y += Je.y);
                  var c = wt();
                  return (Y = !0), Ce("onVerticalDrag", c), $e(c), void Ie();
                }
                (function (e, t, i) {
                  if (e - F > 50) {
        ...
        At = function (e) {
          ...
          var t;
          if ((Ce("pointerUp"), gt(e, !1) && e.preventDefault(), A)) {
          ...
          if (
            ...
            if ((Ue(), H || (H = Et()), H.calculateSwipeSpeed("x"), Y))
              ...
              if (!te)
                return "swipe" !== n
                  ? void _t()
                  : void (!K && v > a.currItem.fitRatio && Pt(H));
            }
        },
        Et = function () {
          var e,
        ...
        Bt = function (e, t, i) {
          if (e.src && !e.loadError) {
            ...
            if (
              ...
              (Yt.x = t.x),
              (Yt.y = t.y - e.vGap.top - e.vGap.bottom),
              n)
            ) {
              var o = Yt.x / e.w,
                a = Yt.y / e.h;
            ...
            return (
              (function (e, t, i) {
                var n = e.bounds;
                (n.center.x = Math.round((Yt.x - t) / 2)),
                  (n.center.y = Math.round((Yt.y - i) / 2) + e.vGap.top),
                  (n.max.x = t > Yt.x ? Math.round(Yt.x - t) : n.center.x),
                  (n.max.y =
                    i > Yt.y ? Math.round(Yt.y - i) + e.vGap.top : n.center.y),
                  (n.min.x = t > Yt.x ? 0 : n.center.x),
                  (n.min.y = i > Yt.y ? e.vGap.top : n.center.y);
              })(e, e.w * i, e.h * i),
              n &&
        ...
        publicMethods: {
          ...
          initController: function () {
            o.extend(r, zt, !0),
              ...
              Se("mainScrollAnimComplete", Zt),
              Se("initialZoomInEnd", Zt),
              Se("destroy", function () {
          ...
          setContent: function (e, t) {
            ...
            if (l) {
              ...
              Rt || t !== u ? Ae(l) : ((ee = c.style), Wt(l, n || l.img)),
                (e.el.innerHTML = ""),
                e.el.appendChild(c);
            } else e.el.innerHTML = "";
          },
      ...
      var ti,
        ...
        gi = function () {
          if ((ni && clearTimeout(ni), Be || z)) ni = setTimeout(gi, 500);
          else {
        ...
        t.extend(e.options, C, !0),
          ...
          (function () {
            ...
            d("onVerticalDrag", function (e) {
              k && 0.95 > e
                ? w.hideControls()
                : !k && e >= 0.95 && w.showControls();
            }),
              d("onPinchClose", function (t) {
                k && 0.9 > t
                  ? (w.hideControls(), (e = !0))
                  : e && !k && t > 0.9 && w.showControls();
              }),
          ...
          if (!g)
            if (i.detail && "mouse" === i.detail.pointerType) {
              ...
              (v.tapToToggleControls &&
                (k ? w.hideControls() : w.showControls()),
    ...
    var t = function (e) {
      ...
      i = function (e, t, i, n) {
        ...
        if (
          ((a = (function (e) {
            for (
              var t, i, n, o, a = e.childNodes, r = a.length, s = [], l = 0;
              l < r;
              l++
            )
              1 === (t = a[l]).nodeType &&
  ...
  (function (e) {
    e.fn.sticky = function (t) {
      ...
      return this.each(function () {
        ...
        p.innerHeight() > a &&
          (p.bind("scroll", h), p.bind("load", h), p.bind("resize", h));
      });
    };
  })(jQuery),
  (function (e, t) {
    ...
    (y.prototype.bind = function (e, t) {
      ...
      (y.prototype.unbind = function (e, t) {
        ...
        this.handlers[e] = this.handlers[e].filter(function (n) {
          return (
            !(!t || n === t) || (i.element.removeEventListener(e, n, !1), !1)
          );
        });
      }),
          ...
          e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight
            ? ((e.scrollbarYActive = !0),
              ...
              (e.scrollbarYHeight = p(
                e,
                u((e.railYHeight * e.containerHeight) / e.contentHeight)
              )),
              (e.scrollbarYTop = u(
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      this.css(this.image.$item, {
                        ...
                        marginTop: r + "px",
                        left:
                          "fixed" === this.image.position ? e.left + "px" : "0",
                        width: e.width + "px",
                      }),
          ...
          C = function (e) {
            ...
            for (
              ...
              if (
                ...
                void 0 === t
                  ? e[o].jarallax || (e[o].jarallax = new S(e[o], t))
                  : e[o].jarallax &&
                    ...
                    : t.onAPIready(function () {
                        ...
                        if ("local" === t.type) {
                          ...
                          t.player.addEventListener("playing", function (e) {
                            ...
                            t.player.addEventListener("volumechange", function (
                              e
                            ) {
                ...
                this.$input.on("keyup", function (i) {
                  ...
                  if ((t.$autocompleteWrap.empty(), n.length)) {
                    for (var o in t.options.data)
                      if (
                        -1 !==
                        t.options.data[o].toLowerCase().indexOf(n.toLowerCase())
                      ) {
