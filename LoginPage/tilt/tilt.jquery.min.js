			...
			var s = function() {
				...
				h = function() {
					var i = t(this).outerWidth(),
						...
						o = (this.settings.maxTilt / 2 -
							a * this.settings.maxTilt).toFixed(2),
						l = (r * this.settings.maxTilt -
							this.settings.maxTilt / 2).toFixed(2),
						h =
							Math.atan2(
				...
				c = function() {
					...
					if (
						...
						(this.glareElementWrapper = t(this).find(
							'.js-tilt-glare'
						)),
